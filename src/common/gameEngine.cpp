...
void GameEngine::handleGameOver(TetrisGame& /*eventually have game*/) {
...
void GameEngine::sendToEnemy(int linesCleared, TetrisGame& enemyGame) { std::cerr << "You cannot acces the sendToEnemy methode by GameEngine"; }
void GameEngine::handleEnergy(TetrisGame &game, const int linesCleared) { std::cerr << "You cannot acces the handleEnergy methode by GameEngine"; }