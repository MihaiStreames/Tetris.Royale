...
// Malus Method
void TetrisGame::inverted_command(bool flag) { std::cerr << "You tried to acces power-ups via TetrisGame"; }

void TetrisGame::block_command() { std::cerr << "You tried to acces power-ups via TetrisGame"; }

void TetrisGame::thunder_strike() { std::cerr << "You tried to acces power-ups via TetrisGame"; }
void TetrisGame::fast_falling_pieces() { std::cerr << "You tried to acces power-ups via TetrisGame"; }
void TetrisGame::darkMode() { std::cerr << "You tried to acces power-ups via TetrisGame"; }
void TetrisGame::addPenaltyLines(int linesToAdd) { std::cerr << "You tried to acces power-ups via TetrisGame"; } 

// Bonus Method
void TetrisGame::blocs_1x1() { std::cerr << "You tried to acces power-ups via TetrisGame"; }
void TetrisGame::slow_falling_pieces() { std::cerr << "You tried to acces power-ups via TetrisGame"; }