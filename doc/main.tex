...
2.1 & Oleksandra Omelyanyuk & Modifications texte & 08/05/2025 \\ \hline
3 & Oleksandra Omelyanyuk & Modifications diagrammes & 08/05/2025 \\ \hline
\end{longtable}
...
\begin{itemize}
    ...
    \item \textbf{Inviter un ami} : L'utilisateur peut inviter un ami dans une partie en lui envoyant son lobbyID par message.
\end{itemize}
