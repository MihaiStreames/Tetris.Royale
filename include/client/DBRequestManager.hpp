...
public:
    ...
    DBResponse getMessages(
        const std::string &accountID,
        const std::string &otherAccountID
    );

    // POST Requests
    DBResponse registerPlayer(
        const std::string &userName,
        const std::string &password
    );

    DBResponse loginPlayer(
        const std::string &userName,
        const std::string &password
    );

    DBResponse updatePlayer(
        const std::string &accountID,
        const std::string &newName = "",
        const std::string &newPassword = ""
    );

    DBResponse postPlayerScore(
        const std::string &accountID,
        int score
    );

    DBResponse sendFriendRequest(
        const std::string &senderID,
        const std::string &receiverID
    );

    DBResponse acceptFriendRequest(
        const std::string &receiverID,
        const std::string &senderID
    );

    DBResponse declineFriendRequest(
        const std::string &receiverID,
        const std::string &senderID
    );

    DBResponse removeFriend(
        const std::string &accountID,
        const std::string &removedID
    );

    DBResponse postMessage(
        const std::string &senderID,
        const std::string &receiverID,
